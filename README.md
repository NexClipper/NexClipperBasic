We have rebuilt NexClipper with new architecture & components. All-new [NexClipper](https://github.com/NexClipper/NexClipper) version 0.2.0 is to be released soon.
...
Please note that previous  NexClipper Light project which was host level container monitoring tool was moved to [NexLight](https://github.com/NexClipper/NexClipperBasic/tree/master/NexLight) directory.
...
- [If you want to use HELM chart to install, Go to](https://github.com/NexClipper/NexClipperBasic/blob/master/HELM/README.md)
...
- [If you want to use your own database instead of 'detaultdb', Go to](https://github.com/NexClipper/NexClipperBasic/blob/master/docs/option/mysql.md)
...
- [If you want to use Kafka instead of RabbitMQ, Go to](https://github.com/NexClipper/NexClipperBasic/blob/master/docs/option/kafka.md)
...
- [If you don't use 'defaultdb' for MySQL or use kafka, Go to](https://github.com/NexClipper/NexClipperBasic/blob/master/docs/option/workflow.md)
...
- [If you don't use 'defaultdb' for MySQL or use kafka, Go to](https://github.com/NexClipper/NexClipperBasic/blob/master/docs/option/collector.md)
...
- [If you want to use your own database insted of 'detaultdb', Go to](https://github.com/NexClipper/NexClipperBasic/blob/master/docs/option/nexservice.md)
...
NexClipper is licensed under the Apache License, Version 2.0. See [LICENSE](https://github.com/NexClipper/NexClipperBasic/blob/master/LICENSE) for the full license text.
